...
GC_LOG=" -verbose:gc -Xloggc:log/cms/gc_pid_%p.log -XX:+PrintGCDateStamps -XX:+PrintGCDetails -XX:+UseGCLogFileRotation -XX:NumberOfGCLogFiles=10 -XX:GCLogFileSize=100M"
...
DUMP="-XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=dump"

#-XX:OnOutOfMemoryError="kill -3 %p"

java $REMOTE_DEBUG $MEMORY $GC $GC_LOG $JMX $DUMP -jar target/hmw04.jar
